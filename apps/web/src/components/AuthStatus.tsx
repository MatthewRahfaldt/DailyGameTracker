...
/**
 * Server Component that shows "Sign in with GitHub" / "Sign in with Google" buttons, or the
 * signed-in user + a sign-out button. Uses inline Server Actions (the `"use server"` functions
 * below) — no client-side JS or API route needed for the buttons themselves.
 */
